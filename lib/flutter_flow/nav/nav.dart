...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'SigninContinue',
          path: '/signinContinue',
          builder: (context, params) => const SigninContinueWidget(),
        ),
        FFRoute(
          name: 'CreateAccount',
          path: '/createAccount',
        ...
        FFRoute(
          ...
          builder: (context, params) => const ResetPasswordNotificationWidget(),
        ),
        FFRoute(
          name: 'aboutInfo',
          path: '/aboutInfo',
          builder: (context, params) => const AboutInfoWidget(),
        ),
        FFRoute(
          name: 'home',
          path: '/home',
