        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FlutterFlowDropDown<String>(
                      ...
                      options:
                          List<String>.from(['Men', 'Women', 'Option 3', '3']),
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(24.0, 50.0, 0.0, 0.0),
                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.asset(
                                                    'assets/images/Rectangle_8_(6).png',
                                                    width: double.infinity,
                                                    height: 220.0,
                                                    fit: BoxFit.cover,
                                                  ),
                                                      ...
                                                      child: ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(8.0),
                                                        child: Image.asset(
                                                          'assets/images/Rectangle_8_(5).png',
                                                          width:
                                                              double.infinity,
                                                          height: 220.0,
                                                          fit: BoxFit.cover,
                                                ...
                                                ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.asset(
                                                    'assets/images/Rectangle_8_(4).png',
                                                    width: double.infinity,
                                                    height: 220.0,
                                                    fit: BoxFit.cover,
                                                  ),
