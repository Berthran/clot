...
import 'reset_password_notification_model.dart';
export 'reset_password_notification_model.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: Padding(
            padding: const EdgeInsetsDirectional.fromSTEB(24.0, 250.0, 24.0, 0.0),
            child: Column(
